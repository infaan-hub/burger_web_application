...
export default function Settings() {
  ...
  return (
    <div className="pt-24 px-6 md:px-8 max-w-2xl mx-auto pb-16 text-white">
      ...
      {auth?.user?.avatar_url && auth.user.avatar_url.includes('googleusercontent.com') ? (
        <div className="flex justify-center mb-6">
          <div className="w-24 h-24 rounded-full bg-white/5 border-2 border-amber-400/50 flex flex-col items-center justify-center gap-1">
            ...
            <span className="text-white/40 text-[8px] font-semibold">Powered by Google</span>
          </div>
        </div>
